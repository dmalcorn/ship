...
| Audit Report (MVP) | Tuesday, 11:59 PM (36 hours) | Baseline measurements for all 7 categories |
| Early Submission | Friday, 11:59 PM | Measurable improvements across all 7 categories |
...
**Improve all 7 categories.** Your audit report guides your priorities, but you must deliver measurable improvement in every category. The passing threshold for each category is defined by its Improvement Target above.
...
Track your AI tool usage during this project. This is a codebase comprehension project, and we want to understand how AI tools help (or hinder) that process.
...
|---|---|
| GitHub Repository | Forked repo with all improvements on clearly labeled branches. Setup guide in README. |
